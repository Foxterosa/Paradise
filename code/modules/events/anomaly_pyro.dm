...
/datum/event/anomaly/anomaly_pyro/announce()
	GLOB.event_announcement.Announce("Anomalia atmosferica detectada en los escaneres de largo alcance. Ubicacion esperada: [impact_area.name].", "Alerta de Anomalia")
