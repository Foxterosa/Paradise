		...
		switch(level)
			...
			if(SEC_LEVEL_BLUE)
				if(GLOB.security_level < SEC_LEVEL_BLUE)
					...
					GLOB.security_announcement_down.Announce("La amenaza inmediata ha pasado. Es posible que seguridad ya no tenga armas desenfundadas en todo momento, pero puede seguir haci�ndolas visibles. Las busquedas aleatorias aun estan permitidas.","Atencion! Nivel de seguridad bajado a azul.")
			...
			if(SEC_LEVEL_GAMMA)
				GLOB.security_announcement_up.Announce("Comando Central ha ordenado el nivel de seguridad Gamma en la estaci�n. Seguridad puede tener armas equipadas en todo momento, y todos los civiles deben buscar inmediatamente a su jefe mas cercano para el transporte a un lugar seguro. La armeria Gamma de la estaci�n se ha desbloqueado y esta lista para usar.","Atencion! Nivel de seguridad gamma activado!", new_sound = sound('sound/effects/new_siren.ogg'))
