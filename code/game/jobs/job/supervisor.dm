...
/datum/job/blueshield
	...
	exp_type = EXP_TYPE_COMMAND
	minimal_player_age = 21
	access = list(ACCESS_SECURITY, ACCESS_SEC_DOORS, ACCESS_PILOT, ACCESS_BRIG, ACCESS_COURT, ACCESS_FORENSICS_LOCKERS,
			            ACCESS_MEDICAL, ACCESS_ENGINE, ACCESS_CHANGE_IDS, ACCESS_EVA, ACCESS_HEADS,
			            ACCESS_ALL_PERSONAL_LOCKERS, ACCESS_MAINT_TUNNELS, ACCESS_BAR, ACCESS_JANITOR, ACCESS_CONSTRUCTION, ACCESS_MORGUE,
			            ACCESS_CREMATORIUM, ACCESS_KITCHEN, ACCESS_CARGO, ACCESS_CARGO_BOT, ACCESS_MAILSORTING, ACCESS_QM, ACCESS_HYDROPONICS, ACCESS_LAWYER,
			            ACCESS_THEATRE, ACCESS_CHAPEL_OFFICE, ACCESS_LIBRARY, ACCESS_RESEARCH, ACCESS_MINING, ACCESS_HEADS_VAULT, ACCESS_MINING_STATION,
...
/datum/job/lawyer
	...
	spawn_positions = 2
	is_legal = 1
	supervisors = "el Magistrado"
	department_head = list("Capitan")
	selection_color = "#ddddff"
	access = list(ACCESS_LAWYER, ACCESS_MINING, ACCESS_KITCHEN, ACCESS_CHAPEL_OFFICE, ACCESS_HYDROPONICS, ACCESS_LIBRARY, ACCESS_COURT, ACCESS_SEC_DOORS, ACCESS_MAINT_TUNNELS, ACCESS_BAR, ACCESS_RESEARCH, ACCESS_MEDICAL, ACCESS_CONSTRUCTION, ACCESS_MAILSORTING, ACCESS_CARGO, ACCESS_MORGUE)
